...
public class FirstFit extends Politicas {
    ...
    public Resultado ejecutar(List<Trabajo> listaTrabajos, int tamanioMp, int tiempoCargaMp, int tiempoSelec, int tiempoLiberacion) throws InterruptedException {
        System.out.println("Opción First Fit seleccionada");
        ...
        while (!listaTrabajos.isEmpty()) {
            ...
            while (buscoLugar && i < listaParticiones.size()) {
                Particion particion = listaParticiones.get(i); //manejora la particion donde estoy parada
